...
const boxObjects = document.querySelectorAll( ".page-template-about #middle_content_c div.middle_content_c div.image_c div.box" );
...
(function() {
	new Swiper( ".page-template-about #image_gallery_c div.swiper", {
		autoplay: {
			delay: 7500,
		...
		pagination: {
			...
			renderBullet: function( index, className ) {
				return '<span class="' + className + '">' + $( ".page-template-about #image_gallery_c div.swiper div.swiper-slide" ).eq( index ).html() + "</span>";
			}
		},
		speed: 750
	} );
